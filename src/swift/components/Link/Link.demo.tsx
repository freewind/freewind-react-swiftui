...
import { OpenURLActionProvider } from '../../runtime'
  ...
  return (
    <VStack spacing={18} frame={{ maxWidth: 'infinity', alignment: 'leading' }}>
      <FormSection title="Link / ShareLink / HelpLink">
        <OpenURLActionProvider action={() => 'handled'}>
          <VStack spacing={12} alignment="leading">
            ...
            <Text font="caption" foregroundStyle="secondary">
              不支持系统 share 时，回退复制文本到 clipboard。
            </Text>
            <Text font="caption2" foregroundStyle="secondary">
              Link 现经 openURL action stub 派发。
            </Text>
          </VStack>
        </OpenURLActionProvider>
      </FormSection>
    </VStack>
  )
}
